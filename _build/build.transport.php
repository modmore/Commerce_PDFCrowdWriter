...
if (!defined('MOREPROVIDER_BUILD')) {
    /* define version */
    define('PKG_NAME', 'Commerce_PDFCrowdWriter');
    define('PKG_NAMESPACE', 'commerce_pdfcrowdwriter');
...
$modx->log(modX::LOG_LEVEL_INFO,'Packaged in files, requirements check, and modules resolver.'); flush();
flush();
