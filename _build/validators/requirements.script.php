...
switch($options[xPDOTransport::PACKAGE_ACTION]) {
    ...
    /** @var Commerce|null $commerce */
        ...
        if ($success) {
            $modx->log(xPDO::LOG_LEVEL_INFO, 'Requirements look good! After installing the package, navigate to Commerce > Configuration > Modules to enable the module.');
        }
        else {
