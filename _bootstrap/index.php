...
if (!createObject('modNamespace',array(
    'name' => 'commerce_pdfcrowdwriter',
    'path' => $componentPath.'/core/components/commerce_pdfcrowdwriter/',
    'assets_path' => $componentPath.'/assets/components/commerce_pdfcrowdwriter/',
),'name', false)) {
    echo "Error creating namespace commerce_pdfcrowdwriter.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_pdfcrowdwriter.core_path',
    'value' => $componentPath.'/core/components/commerce_pdfcrowdwriter/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_pdfcrowdwriter',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_pdfcrowdwriter.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_pdfcrowdwriter.assets_path',
    'value' => $componentPath.'/assets/components/commerce_pdfcrowdwriter/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_pdfcrowdwriter',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_pdfcrowdwriter.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_pdfcrowdwriter/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_pdfcrowdwriter.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_pdfcrowdwriter',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_pdfcrowdwriter.assets_url setting.\n";
}
...
include $componentPath . '/core/components/commerce_pdfcrowdwriter/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_pdfcrowdwriter/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\Commerce\\PDFCrowdWriter\\Modules\\', $modulePath);
